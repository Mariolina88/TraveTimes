...
public class ProbabilitiesBackward extends JGTModel{
	...
	@Description("S: S value for the given time considered")
	double S_t;


	@Description("S: S at time t+1")
	double S_t1;
	...
	@Description("threshold on the minimum value of the odfs to be considered")
	...
	public void process() throws Exception {
		 ...
		 * the loop starts continues until the value of the residence time pdf
		 * is above the fixed threshold and the computations are made from the time
	 ...
	 */
	public double computeP(double SASvalue_t){
